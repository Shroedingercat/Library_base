...
class DataBase:
    ...
    def __init__(self):
        ...
        self.keys = {"Books": ["(name,author,year,publishing_home)", "(%s, %s, %s, %s)"],
                     "Readers": ["(name,telephone_number,year_of_birth)", "(%s, %s, %s)"],
                     "Orders": ["(book_id,reader_id,date_of_issue,return_date)", "(%s, %s, %s, %s)"]}
