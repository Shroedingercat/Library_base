...
if __name__ == '__main__':
    ...
    imgobj = Image.open(os.path.abspath(os.curdir)[:8] + "Graphics\\" + "diskette.jpg")
    img = PhotoImage(imgobj)
    btn_save = Button(toolbar, image=img, command= app.Save)
    btn_save.pack(side=LEFT)
    btn_ttp = CreateToolTip(btn_save, "Save table")

    imgobj2 = Image.open(os.path.abspath(os.curdir)[:8] + "Graphics\\" + "rules.png")
    ...
    imgobj3 = Image.open(os.path.abspath(os.curdir)[:8] + "Graphics\\" + "new-database.png")
    ...
    imgobj4 = Image.open(os.path.abspath(os.curdir)[:8] + "Graphics\\" + "Search.png")
